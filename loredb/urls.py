...
urlpatterns = [
    ...
    path("elements/world/<int:world_id>/edit/access/edit/<int:user_id>/", views.edit_collaborator, name="edit_collaborator"),
    ...
    path("elements/world/<int:world_id>/objects/", views.objects, name="objects"),
    path("elements/world/<int:world_id>/races/", views.races, name="races"),
    path("elements/world/<int:world_id>/factions/", views.factions, name="factions"),
    path("elements/world/<int:world_id>/groups/", views.groups, name="groups"),
    ...
    path("elements/world/<int:world_id>/objects/<int:object_id>/", views.object_detail, name="object_detail"),
    path("elements/world/<int:world_id>/races/<int:race_id>/", views.race_detail, name="race_detail"),
    path("elements/world/<int:world_id>/factions/<int:faction_id>/", views.faction_detail, name="faction_detail"),
    path("elements/world/<int:world_id>/groups/<int:group_id>/", views.group_detail, name="group_detail"),
